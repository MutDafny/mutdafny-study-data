...
module Bytecode {
    ...
    decreases st
  {
    if st.Operands() >= 3 then
      ...
      var res: int := if rem == 0 then 0 else rem;
  ...
  {
    if st.Operands() >= 1 then
      var account: u160 := TWO_160 as u160;
    ...
    decreases st
  {
    if st.Operands() >= 4 then
      var address: u160 := TWO_160 as u160;
...
module U32 {
  ...
  function Log2(v: u32): (r: nat)
    ...
    decreases v
  {
    var low: u16 := TWO_16 as u32 as u16;
...
module U64 {
  ...
  function Log2(v: u64): (r: nat)
    ...
    decreases v
  {
    var low: u32 := TWO_32 as u64 as u32;
...
module U128 {
  ...
  function Log2(v: u128): (r: nat)
    ...
    decreases v
  {
    var low: u64 := TWO_64 as u128 as u64;
...
module U256 {
    ...
    decreases lhs, rhs
  {
    if rhs >= 256 then
      ...
      var p: nat := MathUtils.Pow(2, rhs as nat); var n: int := lhs as nat * p; TWO_256 as u256
  }
  ...
  function Log2(v: u256): (r: nat)
    ...
    decreases v
  {
    var low: u128 := TWO_128 as u256 as u128;
    ...
    decreases v, k
  {
    ...
    var w64: u64 := U128.NthUint64(w128, 16 / 8);
    var w32: u32 := U64.NthUint32(w64, 8 / 4);
    var w16: u16 := U32.NthUint16(w32, 4 / 2);
    U16.NthUint8(w16, 2)
  }
