...
module Precompiled {
    ...
    decreases data
  {
    ...
    var key: Array<u8> := if !(v in {27, 28}) then [] else fn(h, v as u8, r, s);
    Some((key, G_ECDSA))
  }
