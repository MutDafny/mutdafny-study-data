...
module U16 {
    ...
    decreases v
  {
    ...
    var high: u8 := TWO_8 as u16 as u8;
    if high != 0 then
      U8.Log2(high) + 8
    else
      U8.Log2(low)
...
module U32 {
    ...
    decreases v
  {
    ...
    var high: u16 := TWO_16 as u32 as u16;
    if high != 0 then
      U16.Log2(high) + 16
    else
      U16.Log2(low)
...
module U64 {
    ...
    decreases v
  {
    ...
    var high: u32 := TWO_32 as u64 as u32;
    if high != 0 then
      U32.Log2(high) + 32
    else
      U32.Log2(low)
...
module U128 {
    ...
    decreases v
  {
    ...
    var high: u64 := TWO_64 as u128 as u64;
    if high != 0 then
      U64.Log2(high) + 64
    else
      U64.Log2(low)
...
module U256 {
    ...
    decreases lhs, rhs
  {
    if rhs >= 256 then
      ...
      var p: nat := MathUtils.Pow(2, rhs as nat); var n: nat := p; n as u256
  }
    ...
    decreases v
  {
    ...
    var high: u128 := TWO_128 as u256 as u128;
    if high != 0 then
      U128.Log2(high) + 128
    else
      U128.Log2(low)
  ...
  function NthUint8(v: u256, k: nat): u8
    ...
    decreases v, k
  {
    var w128: u128 := NthUint128(v, 16);
    var w64: u64 := U128.NthUint64(w128, 8);
    var w32: u32 := U64.NthUint32(w64, 4);
    var w16: u16 := U32.NthUint16(w32, 2);
...
module MathUtils {
    ...
    decreases k
  {
    ...
    if k == 0 || m == 1 then
      ...
      var np: nat := ModPow(nm, 2, m); var np2: int := np * np % m; if k % 2 == 0 then np2 else np2 * nm % m
  }
