...
{
  if {
    case l + m <= c.Length && forall i: int :: 0 <= i && i < m =>
      assert a[..m] == c[l .. l + m];
    case l + a.Length <= c.Length && forall i: int :: k <= i && i < a.Length =>
      assert a[k..] == c[l + k .. l + a.Length];
    case l + k + m <= c.Length && forall i: int :: k <= i && i < k + m =>
