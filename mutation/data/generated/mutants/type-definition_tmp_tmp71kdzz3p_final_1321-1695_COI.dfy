...
predicate hasType(gamma: Env, e: Exp, t: Type)
  decreases gamma, e, t
{
  !match e { case Var(x) => x in gamma && t == gamma[x] case Lam(x, t, e) => hasType(gamma, e, t) case App(e1, e2) => hasType(gamma, e1, t) && hasType(gamma, e2, t) case True() => t == Bool case False() => t == Bool case Cond(e0, e1, e2) => hasType(gamma, e0, Bool) && hasType(gamma, e1, t) && hasType(gamma, e2, t) }
}
