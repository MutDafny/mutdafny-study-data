...
module Gas {
    ...
    decreases st
  {
    if st.Operands() >= 7 then
      ...
      var to: u160 := st.Peek(1) as int as u160;
    ...
    decreases st
  {
    if st.Operands() >= 1 then
      var account: u160 := st.Peek(0) as nat as u160;
  ...
  {
    if st.Operands() >= 1 then
      var r: u160 := st.Peek(0) as nat as u160;
...
module U256 {
    ...
    decreases v, k
  {
    ...
    var w64: u64 := U128.NthUint64(w128, k / 8);
    var w32: u32 := U64.NthUint32(w64, k / 4);
    var w16: u16 := U32.NthUint16(w32, k / 2);
    U16.NthUint8(w16, k)
  }
