...
class Heap {
  ...
  method heapify(idx: int) returns (nidx: int)
    ...
    decreases idx
  {
    if idx + 1 >= this.arr.Length && idx + 2 >= this.arr.Length {
      nidx := -1;
      ...
      nidx := idx;
      if idx + 1 < this.arr.Length && this.arr[nidx] < this.arr[idx + 1] {
        nidx := idx + 1;
      }
      if idx + 2 < this.arr.Length && this.arr[nidx] < this.arr[idx + 2] {
        nidx := idx + 2;
      }
      if nidx == idx {
        nidx := -1;
