...
module Context {
  ...
  {
    Context(sender, recipient, address := origin, callValue := callValue, callData := callData, returnData := [], writePermission := writePermission, gasPrice := gasPrice, block := block)
  }
