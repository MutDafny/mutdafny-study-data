...
module Context {
  ...
  {
    Context(sender, origin, address := recipient, callValue := gasPrice, callData := callData, returnData := [], writePermission := writePermission, gasPrice := callValue, block := block)
  }
