...
module Gas {
  ...
  {
    -if st.Operands() >= nOperands then var aCost: nat := CostExpandRange(st, nOperands, aLocSlot, aLenSlot); var bCost: nat := CostExpandRange(st, nOperands, bLocSlot, bLenSlot); Int.Max(aCost, bCost) else G_ZERO
  }
