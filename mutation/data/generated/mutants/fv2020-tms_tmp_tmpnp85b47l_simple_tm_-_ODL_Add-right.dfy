...
module ModelingTM {
  ...
  class TMSystem {
      ...
      decreases that, objs
    {
      ...
      dirtyObjs := that.dirtyObjs;
      lockedObjs := that.lockedObjs;
      objTimeStamps := map o: nat {:trigger that.objTimeStamps[o]} {:trigger o in objs} {:trigger o in that.objTimeStamps} | o in that.objTimeStamps :: if o in objs then that.objTimeStamps[o] else that.objTimeStamps[o];
    }
