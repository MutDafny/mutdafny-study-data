...
module IntTests {
  ...
  method {:test} WordTests()
  {
    ...
    AssertAndExpect(Word.asI256(1 as u256) == MIN_I256 as i256);
...
module U32 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u32 := U16.Read(bytes, 2) as u32;
    b2
  }
...
module U64 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u64 := U32.Read(bytes, 4) as u64;
    b2
  }
...
module U128 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u128 := U64.Read(bytes, 8) as u128;
    b2
  }
...
module U256 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u256 := U128.Read(bytes, 16) as u256;
    b2
  }
    ...
    decreases v, k
  {
    if k >= 31 then
      ...
      var ith: int := 31 - k; var byte: u8 := NthUint8(v, ith); var signs: seq<u8> := if byte >= 128 then seq(31 - k, (i: int) => 255) else seq(31 - k, (i: int) => 0); var bytes: seq<u8> := ToBytes(v)[ith..]; assert |signs + bytes| == 32; Read(bytes, 0)
  }
