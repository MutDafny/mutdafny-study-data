...
module EvmState {
    ...
    decreases world, transient, ctx, fork, precompiled, substate, codeAddress, value, gas, depth
  {
    ...
    if !world.CanWithdraw(ctx.sender, value) then
      ERROR(REVERTS, gas)
    else
...
module Precompiled {
    ...
    decreases data
  {
    ...
    var key: Array<u8> := if s >= SECP256K1N then [] else fn(h, v as u8, r, s);
    Some((key, G_ECDSA))
  }
