...
class Heap {
  ...
  method heapify(idx: int) returns (nidx: int)
    ...
    decreases idx
  {
    if 2 + 1 >= this.arr.Length && 2 + 2 >= this.arr.Length {
      nidx := -1;
      ...
      nidx := idx;
      if 2 + 1 < this.arr.Length && this.arr[nidx] < this.arr[2 + 1] {
        nidx := 2 + 1;
      }
      if 2 + 2 < this.arr.Length && this.arr[nidx] < this.arr[2 + 2] {
        nidx := 2 + 2;
      }
      if nidx == idx {
        nidx := -1;
