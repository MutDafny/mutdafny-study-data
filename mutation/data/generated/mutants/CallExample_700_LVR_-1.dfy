...
module CallExamples {
  ...
  {
    var vm1 := EVM.Init(gas := INITGAS).CreateAccount(3276, -1, 0, map[], [STOP]);
    vm1 := Push1(vm1, 0);
    vm1 := Dup(vm1, 1);
    vm1 := Dup(vm1, 1);
    vm1 := Dup(vm1, 1);
  ...
  {
    var vm1 := EVM.Init(gas := INITGAS).CreateAccount(3276, 0, 0, map[], [STOP]);
    vm1 := Push1(vm1, 0);
    vm1 := Dup(vm1, 1);
    vm1 := Dup(vm1, 1);
    vm1 := Dup(vm1, 1);
  ...
  method {:test} test_call_03()
  {
    ...
    vm1 := MLoad(vm1);
    AssertAndExpect(vm1.EXECUTING?);
    AssertAndExpect(vm1.Peek(0) == 291);
    AssertAndExpect(vm1.Peek(0) == 291);
  }
  ...
  method contractReturns123(vm: EvmState.ExecutingState) returns (vm': EvmState.State)
    ...
    ensures U256.Read(vm'.data, 0) == 291
    decreases vm
  {
    vm' := vm;
    vm' := Push2(vm', 291);
    ...
    vm' := Push1(vm', 0);
    vm' := Return(vm');
    AssertAndExpect(U256.Read(vm'.data, 0) == 291);
  }
