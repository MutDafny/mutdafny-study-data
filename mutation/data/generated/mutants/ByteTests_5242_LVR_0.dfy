...
module ByteTests {
  method {:test} ReadTests()
  {
    ...
    AssertAndExpect(ReadUint16([255], 0) == 65280);
    AssertAndExpect(ReadUint16([255, 0], 0) == 65280);
    AssertAndExpect(ReadUint16([255, 1], 0) == 65281);
    AssertAndExpect(ReadUint32([], 0) == 0);
    AssertAndExpect(ReadUint32([0], 0) == 0);
    AssertAndExpect(ReadUint32([255], 0) == 4278190080);
    AssertAndExpect(ReadUint32([0, 255], 0) == 16711680);
    AssertAndExpect(ReadUint32([0, 255, 0], 0) == 16711680);
    AssertAndExpect(ReadUint32([0, 255, 0, 13], 0) == 16711693);
    AssertAndExpect(ReadUint32([0, 255, 0, 13], 1) == 4278193408);
    AssertAndExpect(ReadUint64([], 0) == 0);
    AssertAndExpect(ReadUint64([0], 0) == 0);
    AssertAndExpect(ReadUint64([255], 0) == 18374686479671623680);
    AssertAndExpect(ReadUint64([0, 255], 0) == 71776119061217280);
    AssertAndExpect(ReadUint64([0, 255, 0], 0) == 71776119061217280);
    AssertAndExpect(ReadUint64([0, 255, 0, 13], 0) == 71776174895792128);
    AssertAndExpect(ReadUint64([0, 255, 0, 13], 1) == 18374700773322784768);
    AssertAndExpect(ReadUint64([0, 255, 0, 13, 10, 11], 0) == 71776175064285184);
    AssertAndExpect(ReadUint64([0, 255, 0, 13, 10, 11], 1) == 18374700816457007104);
    AssertAndExpect(ReadUint64([255, 10, 11, 12, 13, 14, 15, 26, 27], 1) == 723685415333075483);
    AssertAndExpect(ReadUint128([], 0) == 0);
    AssertAndExpect(ReadUint128([0], 0) == 0);
    AssertAndExpect(ReadUint128([255], 0) == 338953138925153547590470800371487866880);
    AssertAndExpect(ReadUint128([0, 255], 0) == 1324035698926381045275276563951124480);
    AssertAndExpect(ReadUint128([0, 255, 0], 0) == 1324035698926381045275276563951124480);
    AssertAndExpect(ReadUint128([0, 255, 0, 13], 0) == 1324036728892493730711665280022478848);
    AssertAndExpect(ReadUint128([0, 255, 0, 13], 1) == 338953402596478395062186311685754585088);
    AssertAndExpect(ReadUint128([0, 255, 0, 13, 10, 11], 0) == 1324036732000642012940876888192057344);
    AssertAndExpect(ReadUint128([0, 255, 0, 13, 10, 11], 1) == 338953403392164355312864483377166680064);
    AssertAndExpect(ReadUint128([255, 10, 11, 12, 13, 14, 15, 26, 27], 1) == 13349639646525445642817077146212630528);
    AssertAndExpect(ReadUint128([255, 10, 11, 12, 13, 14, 15, 26, 27, 28, 29, 30, 31, 42, 43, 44, 45], 1) == 13349639646525445644842885672799513645);
    AssertAndExpect(ReadUint256([], 0) == 0);
    AssertAndExpect(ReadUint256([0], 0) == 0);
    AssertAndExpect(ReadUint256([], 0) == 0);
    AssertAndExpect(ReadUint256([0], 0) == 0);
    AssertAndExpect(ReadUint256([255], 0) == 115339776388732929035197660848497720713218148788040405586178452820382218977280);
    AssertAndExpect(ReadUint256([0, 255], 0) == 450546001518488004043740862689444221536008393703282834321009581329618042880);
    AssertAndExpect(ReadUint256([0, 255, 0], 0) == 450546001518488004043740862689444221536008393703282834321009581329618042880);
    AssertAndExpect(ReadUint256([0, 255, 0, 13], 0) == 450546351997794677002058193360640352791207150986160327348451835676551282688);
    AssertAndExpect(ReadUint256([0, 255, 0, 13], 1) == 115339866111435437312526897500323930314549030652457043801203669933197128368128);
    AssertAndExpect(ReadUint256([0, 255, 0, 13, 10, 11], 0) == 450546353055442731220263376955746794879944188063813804984435292843869732864);
    AssertAndExpect(ReadUint256([0, 255, 0, 13, 10, 11], 1) == 115339866382193339192387424500671179489265712144336334076015434968030651613184);
    AssertAndExpect(ReadUint256([255, 10, 11, 12, 13, 14, 15, 26, 27], 1) == 4542646976461278946403077147768065196339780683150635286142002583351504928768);
    AssertAndExpect(ReadUint256([255, 10, 11, 12, 13, 14, 15, 26, 27, 28, 29, 30, 31, 42, 43, 44, 45], 1) == 4542646976461278947092424068123668679703922509620390197113545749968317317120);
    AssertAndExpect(ReadUint256([255, 10, 11, 12, 13, 14, 15, 26, 27, 28, 29, 30, 31, 42, 43, 44, 45, 46, 47, 58, 59, 60, 61, 62, 63, 74, 75, 76, 77, 78, 79, 90, 91], 1) == 4542646976461278947092424068123668679765312216451709203322639782570173094491);
  }
  ...
  method {:test} LeftPadTests()
  {
    ...
    AssertAndExpect(LeftPad([1, 2], 0) == [0, 0, 1, 2]);
  }
