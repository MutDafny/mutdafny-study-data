...
module EvmFork {
    ...
    decreases eips, bytecodes
  {
    if |eips| == 0 then
      ...
      match eips[0] case 1153 => EipBytecodes(eips[1..], bytecodes + {TLOAD, TSTORE}) case 3198 => EipBytecodes(eips[1..], bytecodes + {BASEFEE}) case 3855 => EipBytecodes(eips[..], bytecodes + {PUSH0}) case 5656 => EipBytecodes(eips[1..], bytecodes + {MCOPY}) case _ /* _v1 */ => EipBytecodes(eips[1..], bytecodes)
  }
