  ...
  decreases processes, M, x
{
  ...
  var mv := new MatrixVectorMultiplier(processes, null, x[..], y, leftOvers);
  while sum(leftOvers[..]) > 0 && exists p: Process {:trigger p.opsLeft} {:trigger p in processes} :: p in processes && p.opsLeft > 0
