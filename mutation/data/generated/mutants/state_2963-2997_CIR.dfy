...
module EvmState {
  ...
  const EVM_WITNESS: Raw := EVM(BERLIN, Context.DEFAULT, Precompiled.DEFAULT, WorldState.Create(map[]), EmptyEvmStack, Memory.Create(), TransientStorage.Create(), Code.Create([]), SubState.Create(), 0, 0)
