...
module Gas {
  ...
  function CostSelfDestruct(st: ExecutingState): nat
    decreases st
  {
    -if st.Operands() >= 1 then var r: u160 := (st.Peek(0) as nat % TWO_160) as u160; G_SELFDESTRUCT + CostSelfDestructAccess(st, r) + CostSelfDestructNewAccount(st, r) else G_ZERO
  }
