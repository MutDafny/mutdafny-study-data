...
module IntTests {
  ...
  {
    AssertAndExpect(U16.NthUint8(56960, 0) == 222);
    AssertAndExpect(U16.NthUint8(56960, 1) == 128);
    AssertAndExpect(U32.NthUint16(305192576, 0) == 4656);
    AssertAndExpect(U32.NthUint16(305192576, 1) == 56960);
    AssertAndExpect(U64.NthUint32(4822678189205111, 0) == 1122867);
    AssertAndExpect(U64.NthUint32(4822678189205111, 1) == 1146447479);
    AssertAndExpect(U128.NthUint64(88962710306127702866241727433142015, 0) == 4822678189205111);
    AssertAndExpect(U128.NthUint64(88962710306127702866241727433142015, 1) == 9843086184167632639);
    AssertAndExpect(U256.NthUint128(30272441630670900764332283662402067389756187285479576190685048339332993280, 0) == 88962710306127702866241727433142015);
    AssertAndExpect(U256.NthUint128(30272441630670900764332283662402067389756187285479576190685048339332993280, 1) == 340193404210632335760508365704335069440);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 0) == 0);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 1) == 1);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 2) == 2);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 3) == 3);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 4) == 4);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 5) == 5);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 6) == 6);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 7) == 7);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 8) == 8);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 9) == 9);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 10) == 10);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 11) == 11);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 12) == 12);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 13) == 13);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 14) == 14);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 15) == 15);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 16) == 16);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 17) == 17);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 18) == 18);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 19) == 19);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 20) == 20);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 21) == 21);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 22) == 22);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 23) == 23);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 24) == 24);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 25) == 25);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 26) == 26);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 27) == 27);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 28) == 28);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 29) == 29);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 30) == 30);
    AssertAndExpect(U256.NthUint8(1780731860627700044960722568376592200742329637303199754547598369979440671, 31) == 31);
  }

  method {:test} ToBytesTests()
  {
    AssertAndExpect(U16.ToBytes(0) == [0, 0]);
    AssertAndExpect(U16.ToBytes(1) == [0, 1]);
    AssertAndExpect(U16.ToBytes(258) == [1, 2]);
    AssertAndExpect(U16.ToBytes(32769) == [128, 1]);
    AssertAndExpect(U32.ToBytes(0) == [0, 0, 0, 0]);
    AssertAndExpect(U32.ToBytes(1) == [0, 0, 0, 1]);
    AssertAndExpect(U32.ToBytes(258) == [0, 0, 1, 2]);
    AssertAndExpect(U32.ToBytes(33554437) == [2, 0, 0, 5]);
    AssertAndExpect(U64.ToBytes(0) == [0, 0, 0, 0, 0, 0, 0, 0]);
    AssertAndExpect(U64.ToBytes(1) == [0, 0, 0, 0, 0, 0, 0, 1]);
    AssertAndExpect(U64.ToBytes(258) == [0, 0, 0, 0, 0, 0, 1, 2]);
    AssertAndExpect(U64.ToBytes(33554437) == [0, 0, 0, 0, 2, 0, 0, 5]);
    AssertAndExpect(U64.ToBytes(65536 * 33554437) == [0, 0, 2, 0, 0, 5, 0, 0]);
    AssertAndExpect(Int.ToBytes(0) == [0]);
    AssertAndExpect(Int.ToBytes(1) == [1]);
    AssertAndExpect(Int.ToBytes(256) == [1, 0]);
    AssertAndExpect(Int.ToBytes(257) == [1, 1]);
    AssertAndExpect(Int.ToBytes(513) == [2, 1]);
    AssertAndExpect(Int.ToBytes(65535) == [255, 255]);
    AssertAndExpect(Int.ToBytes(65536) == [1, 0, 0]);
    AssertAndExpect(Int.ToBytes(65537) == [1, 0, 1]);
    AssertAndExpect(Int.ToBytes(33554437) == [2, 0, 0, 5]);
    AssertAndExpect(Int.ToBytes(65536 * 33554437) == [2, 0, 0, 5, 0, 0]);
  }

  method {:test} FromBytesTests()
  {
    AssertAndExpect(Int.FromBytes([]) == 0);
    AssertAndExpect(Int.FromBytes([0]) == 0);
    AssertAndExpect(Int.FromBytes([1]) == 1);
    AssertAndExpect(Int.FromBytes([254]) == 254);
    AssertAndExpect(Int.FromBytes([1, 0]) == 256);
    AssertAndExpect(Int.FromBytes([16, 236]) == 4332);
    AssertAndExpect(Int.FromBytes([255, 255]) == 65535);
    assert Int.FromBytes([1, 0, 0]) == 65536;
    AssertAndExpect(Int.FromBytes([1, 0, 0]) == 65536);
    assert Int.FromBytes([1, 1, 1]) == 65793;
    AssertAndExpect(Int.FromBytes([1, 1, 1]) == 65793);
    assert {:fuel FromBytes, 2} Int.FromBytes([2, 0, 0, 5]) == 33554437;
    AssertAndExpect(Int.FromBytes([2, 0, 0, 5]) == 33554437);
  }
  ...
  method {:test} Log256Tests()
  {
    ...
    AssertAndExpect(U256.Log256(128) == 0);
    AssertAndExpect(U256.Log256(255) == 0);
    AssertAndExpect(U256.Log256(256) == 1);
    AssertAndExpect(U256.Log256(1364) == 1);
    AssertAndExpect(U256.Log256(13108) == 1);
    AssertAndExpect(U256.Log256(65535) == 1);
    AssertAndExpect(U256.Log256(65536) == 2);
    ...
    AssertAndExpect(U256.Log256(4294967295) == 3);
    AssertAndExpect(U256.Log256(4294967296) == 4);
    AssertAndExpect(U256.Log256(1099511627775) == 4);
    AssertAndExpect(U256.Log256(1099511627776) == 5);
    AssertAndExpect(U256.Log256(281474976710655) == 5);
    AssertAndExpect(U256.Log256(281474976710656) == 6);
    AssertAndExpect(U256.Log256(72057594037927935) == 6);
    AssertAndExpect(U256.Log256(72057594037927936) == 7);
    AssertAndExpect(U256.Log256(18446744073709551615) == 7);
    AssertAndExpect(U256.Log256(18446744073709551616) == 8);
    AssertAndExpect(U256.Log256(4722366482869645213695) == 8);
    AssertAndExpect(U256.Log256(4722366482869645213696) == 9);
    AssertAndExpect(U256.Log256(1208925819614629174706175) == 9);
    AssertAndExpect(U256.Log256(1208925819614629174706176) == 10);
    AssertAndExpect(U256.Log256(309485009821345068724781055) == 10);
    AssertAndExpect(U256.Log256(309485009821345068724781056) == 11);
    AssertAndExpect(U256.Log256(79228162514264337593543950335) == 11);
    AssertAndExpect(U256.Log256(79228162514264337593543950336) == 12);
    AssertAndExpect(U256.Log256(20282409603651670423947251286015) == 12);
    AssertAndExpect(U256.Log256(20282409603651670423947251286016) == 13);
    AssertAndExpect(U256.Log256(5192296858534827628530496329220095) == 13);
    AssertAndExpect(U256.Log256(5192296858534827628530496329220096) == 14);
    AssertAndExpect(U256.Log256(1329227995784915872903807060280344575) == 14);
    AssertAndExpect(U256.Log256(1329227995784915872903807060280344576) == 15);
    AssertAndExpect(U256.Log256(340282366920938463463374607431768211455) == 15);
    AssertAndExpect(U256.Log256(340282366920938463463374607431768211456) == 16);
    AssertAndExpect(U256.Log256(87112285931760246646623899502532662132735) == 16);
    AssertAndExpect(U256.Log256(87112285931760246646623899502532662132736) == 17);
    AssertAndExpect(U256.Log256(22300745198530623141535718272648361505980415) == 17);
    AssertAndExpect(U256.Log256(22300745198530623141535718272648361505980416) == 18);
    AssertAndExpect(U256.Log256(5708990770823839524233143877797980545530986495) == 18);
    AssertAndExpect(U256.Log256(5708990770823839524233143877797980545530986496) == 19);
    AssertAndExpect(U256.Log256(1461501637330902918203684832716283019655932542975) == 19);
    AssertAndExpect(U256.Log256(1461501637330902918203684832716283019655932542976) == 20);
    AssertAndExpect(U256.Log256(374144419156711147060143317175368453031918731001855) == 20);
    AssertAndExpect(U256.Log256(374144419156711147060143317175368453031918731001856) == 21);
    AssertAndExpect(U256.Log256(95780971304118053647396689196894323976171195136475135) == 21);
    AssertAndExpect(U256.Log256(95780971304118053647396689196894323976171195136475136) == 22);
    AssertAndExpect(U256.Log256(24519928653854221733733552434404946937899825954937634815) == 22);
    AssertAndExpect(U256.Log256(24519928653854221733733552434404946937899825954937634816) == 23);
    AssertAndExpect(U256.Log256(6277101735386680763835789423207666416102355444464034512895) == 23);
    AssertAndExpect(U256.Log256(6277101735386680763835789423207666416102355444464034512896) == 24);
    AssertAndExpect(U256.Log256(1606938044258990275541962092341162602522202993782792835301375) == 24);
    AssertAndExpect(U256.Log256(1606938044258990275541962092341162602522202993782792835301376) == 25);
    AssertAndExpect(U256.Log256(411376139330301510538742295639337626245683966408394965837152255) == 25);
    AssertAndExpect(U256.Log256(411376139330301510538742295639337626245683966408394965837152256) == 26);
    AssertAndExpect(U256.Log256(105312291668557186697918027683670432318895095400549111254310977535) == 26);
    AssertAndExpect(U256.Log256(105312291668557186697918027683670432318895095400549111254310977536) == 27);
    AssertAndExpect(U256.Log256(26959946667150639794667015087019630673637144422540572481103610249215) == 27);
    AssertAndExpect(U256.Log256(26959946667150639794667015087019630673637144422540572481103610249216) == 28);
    AssertAndExpect(U256.Log256(6901746346790563787434755862277025452451108972170386555162524223799295) == 28);
    AssertAndExpect(U256.Log256(6901746346790563787434755862277025452451108972170386555162524223799296) == 29);
    AssertAndExpect(U256.Log256(1766847064778384329583297500742918515827483896875618958121606201292619775) == 29);
    AssertAndExpect(U256.Log256(1766847064778384329583297500742918515827483896875618958121606201292619776) == 30);
    AssertAndExpect(U256.Log256(452312848583266388373324160190187140051835877600158453279131187530910662655) == 30);
    AssertAndExpect(U256.Log256(452312848583266388373324160190187140051835877600158453279131187530910662656) == 31);
    AssertAndExpect(U256.Log256(115792089237316195423570985008687907853269984665640564039457584007913129639935) == 31);
  }
  ...
  method {:test} WordTests()
  {
    ...
    AssertAndExpect(Word.asI256(MAX_I256 as u256) == MIN_I256 as i256);
...
module Utils {
  method AssertAndExpect(p: bool)
    ...
    decreases p
  {
    expect p, "expectation violation";
  }
}
...
module U16 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u16 := bytes[address] as u16;
    b1 * TWO_8 as u16
  }
...
module U32 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u32 := U16.Read(bytes, address) as u32;
    b1 * TWO_16 as u32
  }
...
module U64 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u64 := U32.Read(bytes, address) as u64;
    b1 * TWO_32 as u64
  }
...
module U128 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u128 := U64.Read(bytes, address) as u128;
    b1 * TWO_64 as u128
  }
...
module U256 {
    ...
    decreases bytes, address
  {
    ...
    var b2: u256 := U128.Read(bytes, address) as u256;
    b1 * TWO_128 as u256
  }
    ...
    decreases v, k
  {
    if k >= 31 then
      ...
      var ith: int := 31 - k; var byte: u8 := NthUint8(v, ith); var signs: seq<u8> := if byte >= 128 then seq(31 - k, (i: int) => 255) else seq(31 - k, (i: int) => 0); var bytes: seq<u8> := ToBytes(v)[ith..]; assert |signs + bytes| == 32; Read(signs, 0)
  }
