...
bash scripts/run-scan.sh \
  ...
  --output_directory_path data/generated/scan/data/BOR/DafnyBench/630-dafny_tmp_tmpz2kokaiq_Solution/
```
...
bash scripts/run-mut.sh \
  --input_file_path ../.third-parties/dafnybench/DafnyBench/dataset/ground_truth/630-dafny_tmp_tmpz2kokaiq_Solution.dfy \
  --targets_file_path data/generated/scan/data/BOR/DafnyBench/630-dafny_tmp_tmpz2kokaiq_Solution/targets.csv \
  --helpers_file_path data/generated/scan/data/BOR/DafnyBench/630-dafny_tmp_tmpz2kokaiq_Solution/helpers.txt \
  --output_file_path data/generated/mut/data/BOR/DafnyBench/630-dafny_tmp_tmpz2kokaiq_Solution/data.csv \
  --output_directory_path data/generated/mut/mutants/BOR/DafnyBench/630-dafny_tmp_tmpz2kokaiq_Solution/
```
...
- `data/generated/scan/stats/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|LSR|LBI|CIR|SDL>/<Benchmark name>/<Dafny program name>/data.csv`, runtime data of the execution of MutDafny's `scan` command.
- `data/generated/scan/stats/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|LSR|LBI|CIR|SDL>/<Benchmark name>/<Dafny program name>/targets.csv`, set of mutation targets.

Data files generated by the [`scripts/run-mut.sh`](scripts/run-mut.sh) script:
- `data/generated/mut/data/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|LSR|LBI|CIR|SDL>/<Benchmark name>/<Dafny program name>/data.csv`, runtime data of the execution of MutDafny's `mut` command.
- `data/generated/mut/mutants/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|LSR|LBI|CIR|SDL>/<Benchmark name>/<Dafny program name>/`, mutants (each in a .dfy file) generated by MutDafny. A mutant is either named as:
