...
- `data/generated/scan/stats/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|LSR|LBI|MCR|CIR|SDL>/<Benchmark name>/<Dafny program name>/data.csv`, runtime data of the execution of MutDafny's `scan` command.
- `data/generated/scan/stats/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|LSR|LBI|MCR|CIR|SDL>/<Benchmark name>/<Dafny program name>/targets.csv`, set of mutation targets.
