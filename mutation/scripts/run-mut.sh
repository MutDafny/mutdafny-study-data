...
#   --targets_file_path <full path to the targets.csv file generated by the run-scan.sh script, e.g., $SCRIPT_DIR/../data/generated/scan/data/<mutation operator, e.g., BOR>/<Benchmark name, e.g., DafnyBench>/<Dafny program name, e.g., 630-dafny_tmp_tmpz2kokaiq_Solution>/targets.csv>
#   --helpers_file_path <full path to the helpers.txt file generated by the run-scan.sh script, e.g., $SCRIPT_DIR/../data/generated/scan/data/<mutation operator, e.g., BOR>/<Benchmark name, e.g., DafnyBench>/<Dafny program name, e.g., 630-dafny_tmp_tmpz2kokaiq_Solution>/helpers.txt>
...
cp "$HELPERS_FILE_PATH" "$OUTPUT_DIR_PATH/helpers.txt"
...
rm -f "$OUTPUT_DIR_PATH/helpers.txt" "$tmp_log_file"
