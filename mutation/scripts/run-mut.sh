...
#   --output_directory_path <full path to the directory where mutants will be saved, e.g., $SCRIPT_DIR/../data/generated/mut/mutants/<mutation operator, e.g., BOR>/<Benchmark name, e.g., DafnyBench>/<Dafny program name, e.g., 630-dafny_tmp_tmpz2kokaiq_Solution>/>
#   [help]
# ------------------------------------------------------------------------------
