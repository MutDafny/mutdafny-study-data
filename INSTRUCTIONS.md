...
bash "$(pwd)/mutation/scripts/gen-scan-jobs.sh" \
  ...
  --mutation_operators "BOR,BBR,UOI,UOD,LVR,EVR,VER,LSR,LBI,MRR,MAP,MNR,MCR,MVR,SAR,CIR,CBR,CBE,TAR,DCR,SDL,VDL,SLD,ODL,THI,THD,AMR,MMR,FAR,PRV,SWS,SWV" \
...
- `jobs/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/`
  * `jobs/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/job.sh` which runs `mutation/scripts/run-scan.sh`.
- `logs/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/`
  * `logs/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/job.log` which keeps the stdout and stderr of the execution of the correspondent `job` script.
- `data/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/`
...
- `logs/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/`
  * `logs/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/job.log` which keeps the stdout and stderr of the execution of the correspondent `job` script.
- `mutants/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/`
- `data/<mutation operator, BOR|BBR|UOI|UOD|LVR|EVR|VER|LSR|LBI|MRR|MAP|MNR|MCR|MVR|SAR|CIR|CBR|CBE|TAR|DCR|SDL|VDL|SLD|ODL|THI|THD|AMR|MMR|FAR|PRV|SWS|SWV>/<Benchmark name>/<Dafny program name>/`
